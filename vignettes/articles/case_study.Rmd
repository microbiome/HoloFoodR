...
cat("Proportion of fatty acids with standard deviation below 0.5 is",
    round(mean(rowData(mae[[1]])[["sd"]] < 0.5), 3), "\n")

cat("Proportion of fatty acids with standard deviation below 1 is",
    round(mean(rowData(mae[[1]])[["sd"]] < 1), 3))
```
